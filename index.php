...
<head>
	...
	<title>DATA TAGIHAN INTERNET HotSpot-Warkop</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<marquee>
						<b>DATA TAGIHAN INTERNET <br>HotSpot-Warkop</b>
					</marquee>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										KALIMASHADA NETWORK (PAKET BULANAN)
									</b>
								</span>
							</a>
						</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
            ...
            case 'edit-tagihan':
                  ...
                  break;
            case 'delete-tagihan':
                  include "admin/tagihan/delete_tagihan.php";
                  break;
		...
		<footer class="main-footer">
			...
			<center>
				<strong>Copyright &copy;
					<a href="./">HotSpot-Warkop</a>.</strong> All rights reserved.
			</center>
		</footer>
