	...
	<div class="row">
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-primary">
				...
				<a href="./?page=data-paket" class="small-box-footer">More info
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-yellow">
				...
				<a href="./?page=data-pelanggan" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-red">
				...
				<a href="./?page=buka-tagihan" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
			</div>
		</div>
		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-green">
				...
				<a href="./?page=lunas-tagihan" class="small-box-footer">More info
					<i class="fa fa-arrow-circle-right"></i>
				</a>
			</div>
		</div>