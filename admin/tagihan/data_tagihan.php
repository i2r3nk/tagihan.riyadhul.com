			...
			<div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<?php
                  $no = 1;
                  $sql = $koneksi->query("SELECT p.id_pelanggan, p.nama, p.alamat, p.alamat, p.no_hp, t.id_tagihan, t.tagihan, t.status, t.tgl_bayar 
                ...
                ?>
						...
						<tr>
							...
							<td>
								...
								<a href="https://api.whatsapp.com/send?phone=+62<?php echo $data['no_hp']; ?>&text=Pelanggan Yth Tagihan WiFi HotSpot-Warkop Sdr/i%20<?php echo $data['nama']; ?>,
								%20Anda%20belum%20melakukan%20pembayaran%20Tagihan%20Internet%20sebesar%20*Rp 150,000*%20di mohon segera melakukan pembayaran%20untuk Bulan%20<?php echo $bulan; ?>%20Tahun%20<?php echo $tahun; ?>,
								%20*Abaikan informasi ini jika sdh melakukan pembayaran Terima kasih.*"
