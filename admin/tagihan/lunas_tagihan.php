			...
			<div class="table-responsive">
                ...
                ?>
						...
						<tr>
							...
							<td>
								<a href="?page=edit-tagihan&kode=<?php echo $data['id_tagihan']; ?>" title="Ubah"
								 class="btn btn-warning">
									<i class="glyphicon glyphicon-edit"></i>
								</a>
								<a href="?page=del-tagihan&kode=<?php echo $data['id_tagihan']; ?>" onclick="return confirm('Yakin Hapus Data Ini ?')"
