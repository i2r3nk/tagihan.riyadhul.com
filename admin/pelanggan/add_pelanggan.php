				...
				<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="alamat" name="alamat" placeholder="RW.00 RT.00" required>
							</div>
						</div>
...
<?php
    ...
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_pelanggan (id_pelanggan, nama, alamat, no_hp, email, password, paket, tarif) VALUES (
           '".$_POST['id_pelanggan']."',
          '".$_POST['nama']."',
		  '".$_POST['alamat']."',
		  '".$_POST['no_hp']."',
